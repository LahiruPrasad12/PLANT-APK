    ...
    <ion-content class="background">
      <ion-grid>
        ...
        <ion-row>
          <ion-col>
            <ion-text>
              <h2 style="text-align: center; margin-top: 10%;color: aliceblue;">Register</h2>
            </ion-text>
          </ion-col>
        </ion-row>

        <ion-row class="ion-align-items-center ion-justify-content-center" style="margin-top: 1vh;color: aliceblue;">
        ...
        <ion-row>
          <ion-col>
            <div class="ion-text-center ion-margin-top">
              <span>
                <p style="color: aliceblue;" @click="() => router.push('/login')">
                  Back to login?
                </p>
              </span>
            </div>
