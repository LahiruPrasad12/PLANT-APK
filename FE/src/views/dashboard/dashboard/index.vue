<template>
  <ion-page class="background">
    ...
    <ion-content class="main-container background" fullscreen>
      <ion-searchbar
        ...
        style="color: aliceblue; border-color: aliceblue"
      ></ion-searchbar>
      <ion-loading
        :is-open="is_loading"
      ...
      <div>
        <ion-list style="background-color: transparent">
          <ion-grid>
            ...
            >
              <ion-text style="color: aliceblue">
                <h3>Plants</h3>
              </ion-text>
            </div>
              ...
              <ion-col size="12">
                ...
                >
                  ...
                  <div class="details">
                      ...
                      Name : {{ data.predicted_name }}  Age : {{ data.predicted_week }}
                    
                  </div >
                  <!-- <div class="details">
                    <h2>Name : {{ data.predicted_name }}</h2>
                  </div>
                  <br />
                  <div class="details">
                    <h2>Age : {{ data.predicted_week }}</h2>
                  </div> -->
                </div>
              </ion-col>
            </ion-row>
